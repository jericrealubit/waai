              ...
              {SERVICES.map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="text-sm text-muted-foreground transition-colors hover:text-cyber-cyan"
                  >
                    {service.name}
                  </Link>
                </li>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-2 rounded-full border border-border bg-black/40 px-3.5 py-1.5 font-mono text-xs text-muted-foreground">
            ...
            >
              ...
              <Flame className="h-4 w-4 text-cyber-cyan animate-cyber-fire" />
            </span>

            <span className="text-slate-300">Smoked &amp; Coded by:</span>

            <a
              href="https://www.linkedin.com/in/jericrealubit"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1 font-semibold text-cyber-cyan transition duration-200 hover:text-cyan-300 hover:text-shadow-glow-cyan"
            >
              jeric
