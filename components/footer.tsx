    ...
    <footer className="mt-20 border-t border-border px-6 py-16 md:px-20">
      <div className="mx-auto max-w-7xl">
              ...
              {SERVICES.map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="text-sm text-muted-foreground transition-colors hover:text-source"
                  >
                    {service.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              <li>
                <a
                  ...
                  className="transition-colors hover:text-source"
                >
                  +61 491 098 073
                </a>
              </li>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          <div className="relative flex items-center gap-2 overflow-visible rounded-full border-2 border-line-strong bg-paper px-3.5 py-1.5 font-mono text-xs text-muted-foreground">
            ...
            >
              {/* Two grey smoke puffs and one warm ember, blown off the flame.
                  Grey `--smoke` is theme-aware (darker than concrete on light,
                  lighter than the ground on dark) so the puffs read either way. */}
              <span className="motion-always pointer-events-none absolute bottom-3 h-2 w-2 rounded-full bg-smoke/80 blur-[2px] animate-smoke-1" />
              <span className="motion-always pointer-events-none absolute bottom-3 left-0 h-2.5 w-2.5 rounded-full bg-hivis/45 blur-[3px] animate-smoke-2" />
              <span className="motion-always pointer-events-none absolute bottom-3 right-0 h-1.5 w-1.5 rounded-full bg-smoke/70 blur-[2px] animate-smoke-3" />
              ...
              <Flame className="motion-always h-4 w-4 origin-bottom text-hivis animate-flame" />
            </span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1 font-semibold text-source transition duration-200 hover:text-hivis-text"
            >
              jeric
